...
class FindWindow(tk.Toplevel):
    def __init__(self, master, **kwargs):
        ...
        find_entry_label = tk.Label(top_frame, text='Find: ', style='editor.TLabel')
        self.find_entry = ttk.Entry(top_frame, textvar=self.text_to_find)

        replace_entry_label = tk.Label(middle_frame, text='Replace: ', style='editor.TLabel')
        ...
        self.replace.pack(side=tk.LEFT, padx=(20, 20))
        ...
        # So of the lines of the program are ignored bcz they are not preset in the book.
